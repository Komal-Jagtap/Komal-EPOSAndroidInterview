...
data class GitHubDataHolder(val id: String, val name: String,val  avatar_url:String,val language:String,val forks_count:String,val open_issues_count:String,  @SerializedName("owner")
val owner : Owner
)
